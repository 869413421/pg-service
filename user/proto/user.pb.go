...
var file_proto_user_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x12, 0x04, 0x75, 0x73, 0x65, 0x72, 0x22, 0xdd, 0x01, 0x0a, 0x04, 0x55, 0x73, 0x65,
	...
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0x75, 0x0a, 0x0c, 0x55, 0x73, 0x65, 0x72, 0x52,
	...
	0x52, 0x0b, 0x64, 0x65, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x32, 0x89, 0x02,
	0x0a, 0x0b, 0x55, 0x73, 0x65, 0x72, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x2e, 0x0a,
	0x03, 0x67, 0x65, 0x74, 0x12, 0x11, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x55, 0x73, 0x65, 0x72,
	...
	0x06, 0x67, 0x65, 0x74, 0x41, 0x6c, 0x6c, 0x12, 0x11, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x55,
	...
	0x12, 0x31, 0x0a, 0x06, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x12, 0x11, 0x2e, 0x75, 0x73, 0x65,
	...
	0x65, 0x22, 0x00, 0x12, 0x31, 0x0a, 0x06, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x12, 0x11, 0x2e,
	...
	0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x31, 0x0a, 0x06, 0x64, 0x65, 0x6c, 0x65, 0x74, 0x65,
...
var file_proto_user_proto_depIdxs = []int32{
	...
	0, // 1: user.UserResponse.users:type_name -> user.User
	3, // 2: user.UserResponse.errors:type_name -> user.Error
	1, // 3: user.UserService.get:input_type -> user.UserRequest
	1, // 4: user.UserService.getAll:input_type -> user.UserRequest
	1, // 5: user.UserService.create:input_type -> user.UserRequest
	1, // 6: user.UserService.update:input_type -> user.UserRequest
	1, // 7: user.UserService.delete:input_type -> user.UserRequest
	2, // 8: user.UserService.get:output_type -> user.UserResponse
	2, // 9: user.UserService.getAll:output_type -> user.UserResponse
	2, // 10: user.UserService.create:output_type -> user.UserResponse
	2, // 11: user.UserService.update:output_type -> user.UserResponse
	2, // 12: user.UserService.delete:output_type -> user.UserResponse
